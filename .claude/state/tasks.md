...
| T-0037 | UX改善2/3: T-0036のモードに応じてキャンバスクリック挙動を変更。新規モード=スナップ判定を完全スキップし常に新規打点。編集モード=打点無効化・既設フィーチャへのスナップ判定のみ有効(クリックで選択のみ、空白クリックは無反応)。既存の「キャンバス空白クリックでの選択解除」機能を廃止 | 静的検証中 | `.claude/logs/implement/2026-09-16-T-0037-mode-aware-canvas-click.md` | - | - |
