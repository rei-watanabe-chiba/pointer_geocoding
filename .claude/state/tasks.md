...
| T-0024 | UI改修: 左ドック廃止・右ドック上部4ボタン化(画像/設定/出力/保存)・各機能をモードレスダイアログへ分離 | 人手確認待ち | `.claude/logs/implement/2026-09-16-T-0024-ui-restructure-dialogs.md` | 静的検証: 問題なし。実行環境での確認が必要 | - |
