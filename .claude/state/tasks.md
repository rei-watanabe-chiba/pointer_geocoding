...
| T-0023 | T-0022フォローアップ: SP復帰時採番バグ修正・既存点番号修正機能・選択時赤枠常時表示 | 人手確認待ち | `.claude/logs/implement/2026-09-15-T-0023-sp-numbering-fix-number-correction-selection-marker.md` | 静的検証: 問題なし。実行環境での確認が必要 | - |
