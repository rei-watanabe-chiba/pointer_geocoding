...
| T-0041 | UX軽微改修4点: ①PointNameEntryDialog(解除モード)の点名初期値を直前の点名でプリセット(重複エラー表示になってもよい)②ダイアログの重複エラー文言を「点名重複エラー: [識別子]」形式に変更③点名インプットのスピンボックス矢印つぶれをstart_dialog.py等と比較し原因調査の上修正④tab2先頭の[新規][編集]トグルと点情報パネルの間の余白を通常のPANEL_MARGIN程度に削減 | 実装中 | - | - | - |
