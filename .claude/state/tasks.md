...
| T-0045 | CoreUI試作（`src/ui/core/`: field_spec.py/builder.py/rules.py新設）、tab1_image.pyへ適用。詳細は`.claude/state/v2-coreui-plan.md`、実装ログは`.claude/logs/implement/2026-09-16-T-0045-coreui-tab1.md` | 静的検証中 |
