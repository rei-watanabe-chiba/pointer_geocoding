...
| T-0045-b | tab1におけるCoreUI化・機能分離の追加試行(②座標変換後ダイアログ廃止／③`src/ui/core/validators.py`新設・tab1適用／④LayerManager高レベルAPI追加)。tab1_image.py 1059→1047行。静的検証: 問題なし(未使用定数`MSG_TRANSFORM_COMPLETE_TITLE`残存を軽微事項として指摘、実害なし)。詳細は`.claude/state/v2-coreui-plan.md`「T-0045-b」節、実装ログは`.claude/logs/implement/2026-09-16-T-0045-b-tab1-dialog-validators-layermanager.md` | 人手確認待ち |
