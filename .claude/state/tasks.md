...
| T-0047 | dialogs.py（実測808行）へCoreUI適用（GridInputDialog/FeatureCreateDialog/PointNameEntryDialog）。実装ログ: `.claude/logs/implement/2026-09-17-T-0047-coreui-dialogs.md` | 静的検証中 |
