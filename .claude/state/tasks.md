...
| 軽微修正-01 | tab2_plot.py 図面選択リストパネルに基準点レイヤ表示/非表示ラジオボタン追加（余白調整含む）。初回実装は配置を誤解しており、訂正版を実装済み。verifier静的検証「問題なし。実行環境での確認が必要」。詳細は`.claude/logs/implement/2026-09-17-軽微修正-01-ref-point-visibility-toggle.md`、訂正ログ`.claude/logs/implement/2026-09-17-軽微修正-01-correction.md`、チェックリスト`.claude/logs/implement/2026-09-17-軽微修正-01-ref-point-visibility-toggle-checklist.md` | 人手確認待ち |
