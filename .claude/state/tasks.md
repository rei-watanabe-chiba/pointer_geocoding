...
| 軽微修正-01 | tab2_plot.py 図面選択リストパネルに基準点レイヤ表示/非表示ラジオボタン追加（余白調整含む）。初回実装は配置を誤解しており、訂正版を実装済み。詳細は`.claude/logs/implement/2026-09-17-軽微修正-01-ref-point-visibility-toggle.md`および訂正ログ`.claude/logs/implement/2026-09-17-軽微修正-01-correction.md` | 静的検証中 |
