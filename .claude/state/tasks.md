...
| T-0044 | QSpinBoxへの安全なQSS適用パターン検証。`get_style_sheet()`にQSpinBox/QSpinBox:focus/up-down-button のルールを追加(矢印サブコントロール::up-arrow/::down-arrowには一切触れずimage指定もしない)。色は既存QLineEdit/QComboBoxと揃えてpaletteロール参照に統一、min-width:70px | 人手確認待ち | `.claude/logs/implement/2026-09-16-T-0044-qspinbox-safe-qss.md` | 静的検証: 問題なし | - |
